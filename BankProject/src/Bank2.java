...
//		}
	...
	public void dataTest() throws RemoteException, BadAmount, KeyException, UserException {
		...
		AccountList.add(new Account(UserList.get(1),"B0001",100f));//0
		AccountList.add(new Account(UserList.get(2),"B0002",200f));//1
		AccountList.add(new Account(UserList.get(2),"B0003",100f));
		AccountList.add(new Account(UserList.get(3),"B0004",100f));
		AccountList.add(new Account(UserList.get(3),"B0005",100f));
		AccountList.add(new Account(UserList.get(3),"B0006",100f));
...
//	}
	...
	public AccountInterface returnObjectTest() throws RemoteException {
		System.out.println("Se devolvio: " + aux1);
		return aux1;
	}
